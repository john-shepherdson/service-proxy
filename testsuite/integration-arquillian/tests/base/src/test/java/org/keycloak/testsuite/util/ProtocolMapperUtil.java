...
public class ProtocolMapperUtil {
    ...
    public static ProtocolMapperRepresentation createUserRealmRoleMappingMapper(String realmRolePrefix,
        ...
        return createUserRealmRoleMappingMapper(realmRolePrefix, name, tokenClaimName, accessToken, idToken, introspectionEndpoint, false);
    }
    ...
    public static ProtocolMapperRepresentation createUserClientRoleMappingMapper(String clientId, String clientRolePrefix,
        ...
        return createUserClientRoleMappingMapper(clientId, clientRolePrefix, name, tokenClaimName, accessToken, idToken, introspectionEndpoint, false);
    }
